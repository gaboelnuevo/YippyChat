...
export default class NewIconScreen extends React.Component {
  ...
  constructor (props) {
	...
	this.state = {
		dataSource: ds.cloneWithRows(icons),
	}
  ...
  renderItem(rowData){
  	...
  	return(
  		<TouchableOpacity onPress={()=>this.setIcon(rowData)}>
			<Icon name={rowData} size={22} color='#333' style={styles.listItem} />
		</TouchableOpacity>
  	);
  }
...
export default connect(mapStateToProps)(NewIconScreen)
